 ...
 * @returns {Promise}
 */
export const fetchPost = function (url, params, options) {
 ...
 * @returns {Promise}
 */
export const fetchGet = function (url, params, options) {
  if (options == null) return {};
  let tempOptions = {
    ...options,
    method: 'get',
 ...
 * @returns {Promise}
 */
export const fetchDownload = function (url, params, fileName) {
 ...
 */
export const doUrl = function (url, type, params, axiosOption, options) {
