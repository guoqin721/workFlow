...
const getProps  = route => route.query
/**
...

  {
    ...
    children: [
      { 
        ...
        name: 'flowManage', 
        meta: { title: '流程管理', icon: 'el-icon-s-help', breadcrumb: false },
        // hidden: true
      },
      { 
        path: 'formFlowCategory', 
        component: () => import('@/views/workflow/flowCategory/formFlowCategory'), 
        name: 'formFlowCategory', 
        meta: { title: '流程分类', icon: 'el-icon-s-help' } 
      },
      {
        path: 'formFlowEntry',
      ...
      },
      {
        ...
        component: () => import('@/views/workflow/taskManager/formAllInstance'), 
