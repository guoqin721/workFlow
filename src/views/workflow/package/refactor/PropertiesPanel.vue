  ...
  <div class="process-panel__container" :style="{ width: `${this.width}px` }">
    <el-collapse v-model="activeTab" accordion>
      ...
      <el-collapse-item name="form" v-if="formVisible" key="form">
        <div slot="title" class="panel-tab__title"><i class="el-icon-s-order"></i>任务表单</div>
        <element-form :id="elementId" :type="elementType" />
      </el-collapse-item>
      <el-collapse-item name="variable" v-if="formVisible" key="variable">
      ...
      <el-collapse-item name="listeners" v-if="elementType" key="listeners">
      ...
      <el-collapse-item name="extensions" v-if="elementType" key="extensions">
        <div slot="title" class="panel-tab__title"><i class="el-icon-circle-plus"></i>扩展属性</div>
        <element-properties :id="elementId" :type="elementType" />
      </el-collapse-item>
      <el-collapse-item name="other" v-if="elementType" key="other">
