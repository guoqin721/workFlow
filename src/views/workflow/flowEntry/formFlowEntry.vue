<template>
  <div style="position: relative" class="container">
    <el-form label-width="100px" size="mini" label-position="right" @submit.native.prevent>
      <filter-box :item-width="350">
        ...
        <el-form-item label="发布状态">
          <el-select v-model="formFlowEntry.formFilter.status" class="filter-item" :clearable="true" filterable placeholder="发布状态">
    ...
    <el-row>
      <el-col :span="24">
        <el-table ref="flowEntry" :data="formFlowEntry.flowEntryWidget.dataList" size="mini" header-cell-class-name="table-header-gray" @sort-change="formFlowEntry.flowEntryWidget.onSortChange">
          ...
          <el-table-column label="流程主版本" prop="mainFlowEntryPublish" header-align="center" align="center">
            <template slot-scope="scope">
              ...
              <el-tag v-if="scope.row.mainFlowEntryPublish" size="mini" effect="dark" style="margin-left: 10px" :type="scope.row.mainFlowEntryPublish.activeStatus ? 'success' : 'danger'">
          ...
          <el-table-column label="操作" fixed="right" width="250px">
            <template slot-scope="scope">
              ...
              <el-button type="text" size="mini" :disabled="!checkPermCodeExist('formFlowEntry:formFlowEntry:update')" @click.stop="onPublishedClick(scope.row)">
                发布
              </el-button>
              <el-button type="text" size="mini" :disabled="!checkPermCodeExist('formFlowEntry:formFlowEntry:update')" @click.stop="onPublishedEntryListClick(scope.row)">
                版本管理
              </el-button>
              <el-button class="table-btn delete" type="text" size="mini" :disabled="!checkPermCodeExist('formFlowEntry:formFlowEntry:update')" @click.stop="onDeleteFlowEntryClick(scope.row)">
                删除
              </el-button>
            </template>
          </el-table-column>
    ...
    <FormEditFlowEntry v-if="showFlowEntryDesign" flow-entry="currentFlowEntry" @close="onEditFlowEntryClose" />
  </div>
</template>
